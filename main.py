...
def start(message):
    ...
    btn3 = types.KeyboardButton("🥇 Ціни на дорогоцінні метали")
...
# --- Обробник для кнопки "Ціни на дорогоцінні метали" ---
@bot.message_handler(func=lambda message: message.text == "🥇 Ціни на дорогоцінні метали")
def metals(message):
