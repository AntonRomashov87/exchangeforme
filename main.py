...
def crypto(message):
    try:
        ...
        bot.reply_to(message, "⚠️ Не вдалося отримати дані про криптовалюту\\.")
...
def metals(message):
    try:
        ...
        bot.reply_to(message, "⚠️ Не вдалося отримати ціни на метали\\.")
...
def webhook():
    if request.headers.get('content-type') == 'application/json':
        ...
        print(f"Отримано вебхук: {json_string}")
